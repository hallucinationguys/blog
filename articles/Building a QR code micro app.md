...
subtitle: "Build a serverless 'hello-world' QR code app with Python and AWS. Build a serverless 'hello-world' QR code app with Python and AWS.Build a serverless 'hello-world' QR code app with Python and AWS."
date: "2021-08-14"
---
